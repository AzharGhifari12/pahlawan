...
public class MyDatabase extends SQLiteOpenHelper {
    ...
    public void CreateBurung (Pahlawan mdNotif) {
    ...
    public List<Pahlawan> ReadBurung() {
        List<Pahlawan> judulModelList = new ArrayList<Pahlawan>();
        ...
        if (cursor.moveToFirst()) {
            do {
                Pahlawan mdKontak = new Pahlawan();
    ...
    public int UpdateBurung (Pahlawan mdNotif) {
        SQLiteDatabase db = this.getWritableDatabase();
    ...
    public void DeleteBurung (Pahlawan mdNotif) {
        SQLiteDatabase db = this.getWritableDatabase();
