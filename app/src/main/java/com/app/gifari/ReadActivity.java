...
public class ReadActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    private List<Pahlawan> listPahlawan = new ArrayList<Pahlawan>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter_off = new CustomListAdapter(this, listPahlawan);
        ...
        List<Pahlawan> contacts = db.ReadBurung();
        for (Pahlawan cn : contacts) {
            Pahlawan judulModel = new Pahlawan();
...
//                    break;
    ...
    public void onItemClick(AdapterView<?> parent, View view, int i, long l) {
        ...
        Pahlawan obj_itemDetails = (Pahlawan) o;
